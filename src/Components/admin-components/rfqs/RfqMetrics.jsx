  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <p className="text-2xl font-extrabold text-[#0F172A] mb-2">8,420</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <p className="text-2xl font-extrabold text-[#D4AF37] mb-2">214</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col justify-between">
        <div>
          ...
          <p className="text-2xl font-extrabold text-[#0F172A] mb-4">6,981</p>
        </div>
        <div className="w-full bg-gray-100 rounded-full h-1.5">
          <div className="bg-[#D4AF37] h-1.5 rounded-full" style={{ width: '75%' }}></div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <p className="text-2xl font-extrabold text-[#0F172A] mb-2">1,225</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border-y border-r border-gray-100 border-l-4 border-l-red-500 p-5 relative overflow-hidden">
        ...
        <p className="text-2xl font-extrabold text-red-500 mb-2">17</p>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
        ...
        <p className="text-2xl font-extrabold text-[#0F172A] mb-2">2h 14m</p>
        <div className="flex items-center gap-1 text-[11px] font-bold text-[#D4AF37]">
          <Clock size={12} />
          <span>-4m YoY</span>
        </div>
