    ...
    <>
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500 text-[14px]">Manage your WULFARA listing, RFQs, subscription, and supplier performance.</p>
        </div>
        <button className="flex items-center gap-2 bg-white border border-gray-200 text-sm font-semibold px-4 py-2.5 rounded-lg shadow-sm hover:bg-gray-50 transition">
          <Download size={16} />
          Export Report
        </button>
      </div>

      <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 flex flex-wrap items-center gap-6 text-[13px] mb-8">
