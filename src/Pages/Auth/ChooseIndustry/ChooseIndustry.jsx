            ...
            {industries.map((industry) => {
              ...
              return (
                <div
                  ...
                  className={`relative rounded-xl overflow-hidden cursor-pointer transition-all duration-200 border-2 ${isSelected
                ...
                >
                  ...
                  <div className="p-4 md:p-5">
                    <h3 className={`font-bold text-[13px] md:text-[14px] mb-2 uppercase ${isSelected ? 'text-[#D1A635]' : 'text-gray-900'
                      }`}>
                      {industry.title}
                    </h3>
                  ...
                  {currentSubCategories.map((sub) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2.5 rounded-2xl text-[14px] font-medium transition-colors border ${isSubSelected
