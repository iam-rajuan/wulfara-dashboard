              ...
              <div className="flex justify-between items-center border-b border-gray-50 pb-4">
                ...
                {isEditing ? (
                  <select
                    ...
                    className="text-[13px] font-bold text-gray-900 border border-gray-300 rounded pl-2 pr-6 py-1 outline-none text-right focus:border-[#D1A635]"
                  >
                    <option className='py-2 px-4 bg-gray-50' value="Basic Plan">Basic Plan</option>
                    <option className='py-2 px-4 bg-gray-50' value="Premium Plan">Premium Plan</option>
                    <option className='py-2 px-4 bg-gray-50' value="Pro Plan">Pro Plan</option>
                  </select>
                ) : (
