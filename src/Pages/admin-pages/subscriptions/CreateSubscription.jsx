...
export default function CreateSubscription() {
  ...
  const [formData, setFormData] = useState({
    ...
    description: "Gain maximum visibility in the global supplier directory with advanced analytics.",
    badgeText: "MOST POPULAR",
    accentColor: "#D4AF37", // Matches the screenshot's yellow
    basePrice: "299",
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded text-[14px] text-[#0F172A] appearance-none focus:outline-none focus:border-gray-400"
                      >
                        <option>Standard Digital Service</option>
